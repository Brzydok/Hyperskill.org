...
if __name__ == '__main__':
    ...
    # Write the count_bigger_5 function that counts the number of employees who worked on more than five projects
    def count_bigger_5(series):
        return sum(series > 5)

  
    # Generate a table with metrics according to the boss's needs. 
    boss_table = df_total.groupby(['left'])\
        .agg({'number_project':['median', count_bigger_5],
